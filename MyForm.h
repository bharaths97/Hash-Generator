...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &MyForm::Generate_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &MyForm::Reset_Click);
			// 
			// radioButton1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &MyForm::ChooseFile_Click);
			// 
			// textBox2
			// 
